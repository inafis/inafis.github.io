  ...
  .done(function(data){
    $(jQuery.parseJSON(JSON.stringify(data))).each(function(){
     ...
     if(period.indexOf("/12") >-1){
        ...
        $("#tableData12").append("<tr>");
        $("#tableData12").append("<td>"+period);
        $("#tableData12").append("<td>"+country);
        $("#tableData12").append("<td>"+terrCode);
        $("#tableData12").append("<td>"+legalProc);
        $("#tableData12").append("<td>"+usrDataReq);
        $("#tableData12").append("<td>"+percentReq+"%");
        $("#tableData12").append("<td>"+userSpec);
      }
})  
