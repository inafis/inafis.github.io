  ...
  .done(function(data){
    $(jQuery.parseJSON(JSON.stringify(data))).each(function(){
      ...
      if(period.indexOf("09") > -1){
        ...
        $("#tableData09").append("<tr>");
        $("#tableData09").append("<td>"+period);
        $("#tableData09").append("<td>"+country);
        $("#tableData09").append("<td>"+terrCode);
        $("#tableData09").append("<td>"+legalProc);
        $("#tableData09").append("<td>"+usrDataReq);
        $("#tableData09").append("<td>"+percentReq+"%");
        $("#tableData09").append("<td>"+userSpec);
      }
})  
