//Get Data to fill the chart
$(document).ready(function(){
  var myUrl = "http://localhost:3000/api/requests",
  period,country,terrCode,legalProc,usrDataReq,percentReq,userSpec;
  var mapData1 = [];
  $.get( myUrl, {
    format:"json"
  })
  .done(function(data){
    $(jQuery.parseJSON(JSON.stringify(data))).each(function(){
      period = this.PeriodEnding;
      country = this.Country;
      terrCode = this.CLDRTerritoryCode;
      legalProc = this.LegalProcess;
      usrDataReq = this.UserDataRequests;
      percentReq = this.PercentageRequestsDataProduced;
      userSpec = this.UsersSpecified;

      if(period.indexOf("09") > -1){
        var newElement = {"code":terrCode,"name":country,"value":parseInt(usrDataReq),"color":"#de4c4f"};
        mapData1.push(newElement);
        //console.log(mapData1)
      }
      if(period.indexOf("10") >-1){
       //var newElement = {"code":terrCode,"name":country,"value":parseInt(usrDataReq),"color":"#eea638"};
        //mapData1.push(newElement);
      }
      if(period.indexOf("11") >-1){
        //var newElement = {"code":terrCode,"name":country,"value":parseInt(usrDataReq),"color":"#d8854f"};
        //mapData1.push(newElement);
      }
      if(period.indexOf("12") >-1){
        //var newElement = {"code":terrCode,"name":country,"value":usrDataReq,"color":"#de4c4f"};
        //mapData1.push(newElement);
      }
      if(period.indexOf("13") >-1){
        //var newElement = {"code":terrCode,"name":country,"value":usrDataReq,"color":"#de4c4f"};
        //mapData1.push(newElement);
      }
})  
  ...
  var mapData = [
      ...
      for (var i = 0; i < mapData1.length; i++) {
       ...
       // build map
        ...
        map.addTitle("Google DataRequests Per Country In 2009", 14);
        map.addTitle("source: Google", 11);
        map.areasSettings = {
