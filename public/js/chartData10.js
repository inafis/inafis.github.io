    ...
    $(jQuery.parseJSON(JSON.stringify(data))).each(function(){
      ...
      if(period.indexOf("10") >-1){
       var newElement = {"code":terrCode,"name":country,"value":parseInt(usrDataReq),"color":"#eea638"};
        ...
        $("#tableData10").append("<tr>");
        $("#tableData10").append("<td>"+period);
        $("#tableData10").append("<td>"+country);
        $("#tableData10").append("<td>"+terrCode);
        $("#tableData10").append("<td>"+legalProc);
        $("#tableData10").append("<td>"+usrDataReq);
        $("#tableData10").append("<td>"+percentReq+"%");
        $("#tableData10").append("<td>"+userSpec);
      }
})  
