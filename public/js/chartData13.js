  ...
  .done(function(data){
    $(jQuery.parseJSON(JSON.stringify(data))).each(function(){
      ...
      if(period.indexOf("13") >-1){
        ...
        $("#tableData13").append("<tr>");
        $("#tableData13").append("<td>"+period);
        $("#tableData13").append("<td>"+country);
        $("#tableData13").append("<td>"+terrCode);
        $("#tableData13").append("<td>"+legalProc);
        $("#tableData13").append("<td>"+usrDataReq);
        $("#tableData13").append("<td>"+percentReq+"%");
        $("#tableData13").append("<td>"+userSpec);
