  ...
  .done(function(data){
    $(jQuery.parseJSON(JSON.stringify(data))).each(function(){
      ...
      if(period.indexOf("11") >-1){
        ...
        $("#tableData11").append("<tr>");
        $("#tableData11").append("<td>"+period);
        $("#tableData11").append("<td>"+country);
        $("#tableData11").append("<td>"+terrCode);
        $("#tableData11").append("<td>"+legalProc);
        $("#tableData11").append("<td>"+usrDataReq);
        $("#tableData11").append("<td>"+percentReq+"%");
        $("#tableData11").append("<td>"+userSpec);
      }
